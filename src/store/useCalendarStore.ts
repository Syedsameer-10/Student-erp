  ...
  persist(
    (set) => ({
      events: [
        ...
        { id: '3', title: 'Annual Day', date: '2026-04-20', type: 'Event', scope: 'All', description: 'School annual day celebration.' },
        { id: '4', title: 'Maths Seminar', date: '2026-04-12', type: 'Event', scope: 'Specific Class', description: 'For Class 10-A.' },
      ],
